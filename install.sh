...
echo ""
echo "To open Preferences with a keyboard shortcut instead, set a Custom"
echo "Shortcut in your desktop's Keyboard settings using this exact command:"
echo "  $PYTHON_BIN $NIGHTLIGHT_DIR/nightlight_settings.py"
echo ""
